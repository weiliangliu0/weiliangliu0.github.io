...
.research-topic-page .paper-status {
  font-size: 14pt;
  margin-top: 0;
  margin-bottom: 0.2em;
}

.research-topic-page .paper-description {
  font-size: 12pt;
  margin-top: 0;
  margin-bottom: 1em;
}

.research-topic-page .venue {
  color: #BB180E;
}
</style>
...
<p class="paper-status">Minor Revision at <span class="venue">Operations Research</span></p>
...
<p class="paper-status"><span class="venue">Production &amp; Operations Management</span>, Vol. 35, Issue 1, 2026</p>
...
<p class="paper-description">Reconfigures ambulance-station and emergency-department resources to reduce ambulance offload delays and hospital congestion.</p>
...
<p class="paper-status"><span class="venue">Operations Research</span>, Vol. 73, No. 1, 2025</p>
...
<p class="paper-description">Constructs data-driven uncertainty sets for cardiac-arrest demand and responder behavior and optimizes system deployment against adverse outcomes.</p>
