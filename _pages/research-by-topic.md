...
.research-topic-page .paper-award {
  font-size: 14pt;
  margin-top: 0;
  margin-bottom: 0;
}
...
.research-topic-page .award-result {
  color: blue;
}
</style>
...
<p class="paper-award"><span class="award-result">Finalist</span>, INFORMS Service Science Best Cluster Paper, 2026 (Winner TBA)</p>
...
<p class="paper-award"><span class="award-result">Winner</span>, INFORMS Society on Location Analysis Best Student Paper Award, 2023</p>
